...
import com.satrken.bodega.pojo.Ofs;
...
public class MainActivity extends AppCompatActivity  implements AdapterView.OnItemSelectedListener, SearchView.OnQueryTextListener {
    ...
    private CollectionReference inventarioRef = db.collection("bodega");
    private Spinner spinner;
    private IntentResult result;
    private Button btnAdd;
    private  final static String[] zone = {"zona 1","zona 2","zona 3","zona 4"};
    ...
    public void onItemSelected (AdapterView < ? > parent, View view, int position, long id){
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DocumentReference parciales = db.collection("bodega").document(zona);
